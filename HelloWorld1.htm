...
Elm.WindowSignal = Elm.WindowSignal || {};
Elm.WindowSignal.make = function (_elm) {
   "use strict";
   _elm.WindowSignal = _elm.WindowSignal || {};
   if (_elm.WindowSignal.values)
   return _elm.WindowSignal.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "WindowSignal",
   $Basics = Elm.Basics.make(_elm),
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   $List = Elm.List.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   ...
   $Window.width),
   $Window.height);
   _elm.WindowSignal.values = {_op: _op
